...
public:
	...
	//Band ratio method variables
	float xishu_a1[500];
	int band_bizhi[500][2];
	float threshold_bizhi[500][2];
	float zhengquel_bizhi[500];
	int n_bizhi;

	//Band normalized index variables
	int band_zhishu[500][2];
	float threshold_zhishu[500][2];
	float zhengquel_zhishu[500];
	int n_zhishu;
