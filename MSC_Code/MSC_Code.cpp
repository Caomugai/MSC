...
int main()
{
	...
	// Set sample data path - modify this path according to your data location
	string Sample_data_path = "E:\\programs\\MSC_Code\\MSC_Code\\Sample_data\\Sentinel2\\";

	// Set sensor name (e.g., Sentinel2, Landsat89, etc.)
	...
	Method.Algorithm(Sample_data_path, sensor, bandIndexes);
